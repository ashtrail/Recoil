...
@:sound("/usr/share/haxelib/flixel/4,2,1/assets/sounds/flixel.ogg") @:keep #if display private #end class __ASSET__flixel_sounds_flixel_ogg extends flash.media.Sound {}
@:sound("/usr/share/haxelib/flixel/4,2,1/assets/sounds/beep.ogg") @:keep #if display private #end class __ASSET__flixel_sounds_beep_ogg extends flash.media.Sound {}
@:font("/usr/share/haxelib/flixel/4,2,1/assets/fonts/nokiafc22.ttf") @:keep #if display private #end class __ASSET__flixel_fonts_nokiafc22_ttf extends flash.text.Font {}
@:font("/usr/share/haxelib/flixel/4,2,1/assets/fonts/monsterrat.ttf") @:keep #if display private #end class __ASSET__flixel_fonts_monsterrat_ttf extends flash.text.Font {}
@:bitmap("/usr/share/haxelib/flixel/4,2,1/assets/images/ui/button.png") @:keep #if display private #end class __ASSET__flixel_images_ui_button_png extends flash.display.BitmapData {}
@:bitmap("/usr/share/haxelib/flixel/4,2,1/assets/images/logo/default.png") @:keep #if display private #end class __ASSET__flixel_images_logo_default_png extends flash.display.BitmapData {}
...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		path.set ("assets/sounds/shot.wav", "assets/sounds/shot.wav");
		type.set ("assets/sounds/shot.wav", AssetType.SOUND);
		...
		path.set ("assets/music/Black_Vortex.mp3", "assets/music/Black_Vortex.mp3");
		type.set ("assets/music/Black_Vortex.mp3", AssetType.MUSIC);
		path.set ("assets/music/Past_the_Edge.mp3", "assets/music/Past_the_Edge.mp3");
		type.set ("assets/music/Past_the_Edge.mp3", AssetType.MUSIC);
		className.set ("flixel/sounds/flixel.ogg", __ASSET__flixel_sounds_flixel_ogg);
		type.set ("flixel/sounds/flixel.ogg", AssetType.SOUND);
		className.set ("flixel/sounds/beep.ogg", __ASSET__flixel_sounds_beep_ogg);
		type.set ("flixel/sounds/beep.ogg", AssetType.SOUND);
		...
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/music/Black_Vortex.mp3";
		path.set (id, id);
		type.set (id, AssetType.MUSIC);
		id = "assets/music/Past_the_Edge.mp3";
		path.set (id, id);
		type.set (id, AssetType.MUSIC);
...
@:file("/usr/share/haxelib/flixel/4,2,1/assets/sounds/flixel.ogg") #if display private #end class __ASSET__flixel_sounds_flixel_ogg extends lime.utils.ByteArray {}
@:file("/usr/share/haxelib/flixel/4,2,1/assets/sounds/beep.ogg") #if display private #end class __ASSET__flixel_sounds_beep_ogg extends lime.utils.ByteArray {}
@:font("/usr/share/haxelib/flixel/4,2,1/assets/fonts/nokiafc22.ttf") #if display private #end class __ASSET__flixel_fonts_nokiafc22_ttf extends lime.text.Font {}
@:font("/usr/share/haxelib/flixel/4,2,1/assets/fonts/monsterrat.ttf") #if display private #end class __ASSET__flixel_fonts_monsterrat_ttf extends lime.text.Font {}
@:image("/usr/share/haxelib/flixel/4,2,1/assets/images/ui/button.png") #if display private #end class __ASSET__flixel_images_ui_button_png extends lime.graphics.Image {}
@:image("/usr/share/haxelib/flixel/4,2,1/assets/images/logo/default.png") #if display private #end class __ASSET__flixel_images_logo_default_png extends lime.graphics.Image {}
