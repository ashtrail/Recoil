...
class AssetData {
	...
	public static function initialize():Void {
		...
		if (!initialized) {
			...
			type.set ("assets/music/Black_Vortex.mp3", Reflect.field (AssetType, "music".toUpperCase ()));
			path.set ("assets/music/Past_the_Edge.mp3", "assets/music/Past_the_Edge.mp3");
			type.set ("assets/music/Past_the_Edge.mp3", Reflect.field (AssetType, "music".toUpperCase ()));
			...
			type.set ("assets/sounds/shot.wav", Reflect.field (AssetType, "sound".toUpperCase ()));
